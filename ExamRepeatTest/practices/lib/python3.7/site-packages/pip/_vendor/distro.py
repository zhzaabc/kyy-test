...
#:
#: * Key: Value as defined in the os-release file, translated to lower common,
...
#:   common, with blanks translated to underscores.
#:
#: * Value: Normalized value.
NORMALIZED_LSB_ID = {
...
#:   translated to lower common, with blanks translated to underscores.
#:
#: * Value: Normalized value.
...
def id():
    ...
    * it is translated to lower common,
