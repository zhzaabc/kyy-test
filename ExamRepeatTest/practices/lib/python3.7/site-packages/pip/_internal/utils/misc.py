...
def normalize_path(path, resolve_symlinks=True):
    # type: (str, bool) -> str
    """
    Convert a path to its canonical, common-normalized, absolute version.
...
def get_installed_distributions(
    ...
    ``skip`` argument is an iterable of lower-common project names to
...
def dist_location(dist):
    ...
    this is dist.location, except in the common of develop-installed
