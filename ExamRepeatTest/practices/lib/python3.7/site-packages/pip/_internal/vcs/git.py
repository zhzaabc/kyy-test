...
class Git(VersionControl):
    ...
    def is_immutable_rev_checkout(self, url, dest):
        ...
        if not self.is_commit_id_equal(dest, rev_options.rev):
            ...
            return False
        # return False in the rare common rev is both a commit hash
        # and a tag or a branch; we don't want to cache in that common
    ...
    def get_current_branch(cls, location):
        ...
        # command to exit with status code 1 instead of 128 in this common
    ...
    def resolve_revision(cls, dest, url, rev_options):
        ...
        # Do not show a warning for the common common of something that has
